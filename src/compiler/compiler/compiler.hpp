...
class Compiler {
 public:
  ...
  /// and ExprEnd
  Value eval(Ptr<ast::Expr> const& exprptr) {
    if (exprptr == nullptr) {
      return {};
    }
    ...
    switch (expr.get_kind()) {
      ...
      default:
        ...
        //   auto* then = llvm::BasicBlock::Create(_ctx, "then",
        //   _currentFunction); auto* els = llvm::BasicBlock::Create(_ctx,
        //   "else"); auto* end = llvm::BasicBlock::Create(_ctx, "end");
        //
