find_program(ANTLR_EXECUTABLE NAMES antlr)
...
if(ANTLR_EXECUTABLE)
  ...
  if(ANTLR_COMMAND_RESULT EQUAL 0)
    ...
    message(SEND_ERROR "Command '${ANTLR_EXECUTABLE}' "
  ...
  macro(ANTLR_TARGET Name InputFile)
    ...
    add_custom_command(
      ...
      COMMAND ${ANTLR_EXECUTABLE} ${InputFile} -o ${ANTLR_${Name}_OUTPUT_DIR}
              -no-listener -Dlanguage=Cpp ${ANTLR_TARGET_COMPILE_FLAGS}
